...
dataframe %>% ggplot() +
  ...
  ylab("Density") +
  theme_classic()+ ggtitle(expression(paste("Prior-Posterior Comparison - Average Visit 1 Coherence in Real Pairs (", mu,beta[0]^1,  ") "))) +
...
dataframe %>% ggplot() +
  ...
  geom_vline(xintercept = 0, size = 2)  +
  ylab("Density") +
  theme_classic()+ ggtitle(expression(paste("Prior-Posterior Comparison - Average Visit 4 Coherence in Real Pairs (", mu,beta[0]^2,  ") "))) +
  xlab("Parameter Value")
...
dataframe %>% ggplot() +
  ...
  geom_vline(xintercept = 0, size = 2)  +
  ylab("Density") +
  theme_classic()+ ggtitle(expression(paste("Prior-Posterior Comparison - Average Visit 1 Coherence in Surrogate Pairs (", mu,beta[1]^1,  ") "))) +
  xlab("Parameter Value")
...
dataframe %>% ggplot() +
  ...
  geom_vline(xintercept = 0, size = 2)  +
  ylab("Density") +
  theme_classic()+ ggtitle(expression(paste("Prior-Posterior Comparison - Average Visit 4 Coherence in Surrogate Pairs (", mu,beta[1]^2,  ") "))) +
  xlab("Parameter Value")
